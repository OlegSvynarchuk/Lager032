...
add_action( 'wp_enqueue_scripts', function () {
	...
	wp_enqueue_style(
		'lager032-fonts',
		'https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700&family=Lato:wght@400;700;900&family=Montserrat:wght@500;600;700&family=Oxygen:wght@400;700&family=Roboto+Condensed:wght@400;700&display=swap',
		array(),
		null
	);
