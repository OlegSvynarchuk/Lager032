...
function lager032_get_icon( $name ) {
	$icons = array(
		...
		'mail'   => '<path d="M22 6c0-1.1-.9-2-2-2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6zm-2 0-8 5-8-5h16zm0 12H4V8l8 5 8-5v10z"/>',
		...
		'trash'  => '<path d="M3 6h18v2h-1v12a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V8H3V6zm5 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2h-2V4h-4v2H8zm-2 2v12h12V8H6zm3 2h2v8H9v-8zm4 0h2v8h-2v-8z"/>',
		...
		'home'   => '<path d="M12 3 3 10.2V21h6.2v-6h5.6v6H21V10.2L12 3z"/>',
		'close'  => '<path d="M19 6.41 17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z"/>',
		'back'   => '<path d="M20 11H8.8l3.6-3.6L11 6l-6 6 6 6 1.4-1.4L8.8 13H20z"/>',
