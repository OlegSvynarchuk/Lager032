...
$about_img     = lager_site_image( 'lager_about_img', $home_img . '/about-magacin.jpg?v=' . filemtime( get_template_directory() . '/assets/img/home/about-magacin.jpg' ) );
...
<!-- ============================ HERO ============================ -->
<section class="hero" style="background-image:url('<?php echo esc_url( lager_site_image( 'lager_hero_onama', $home_img . '/hero-onama.jpg' ) ); ?>')">
