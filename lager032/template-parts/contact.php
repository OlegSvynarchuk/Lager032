<?php
/**
 * Reusable contact section (homepage + single product). Form → inc/contact.php.
 *
 * @package Lager032
 */
		...
		<div class="contact__grid">
			...
			<div class="contact__form-wrap">
				...
				<form class="cform" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
					...
					<label><span><?php esc_html_e( 'Email', 'lager032' ); ?> *</span><input type="email" name="email" required></label>
					<label><span><?php esc_html_e( 'Poruka', 'lager032' ); ?> *</span><textarea name="poruka" rows="5" required placeholder="<?php esc_attr_e( 'Opišite šta tražite — dimenzije, šifru, ili aplikaciju...', 'lager032' ); ?>"></textarea></label>
